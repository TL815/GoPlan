...
class PoiDetail {
  ...
  static String _categoryFromTypecode(String? typecode) {
    ...
    switch (prefix) {
      case '14': return 'scenic';    // 风景名胜
      case '05': return 'food';      // 餐饮服务
      case '10': return 'hotel';     // 住宿服务
      case '06': return 'shopping';  // 购物服务
      case '15': return 'transport'; // 交通设施
  ...
  int get categoryColor {
    switch (category) {
      case 'scenic': return 0xFF24D391;
      case 'food': return 0xFFFFA629;
      case 'hotel': return 0xFF4EA9FF;
      case 'shopping': return 0xFFFF6BA6;
      case 'transport': return 0xFF7BC69C;
      default: return 0xFF24D391;
    }
  }
